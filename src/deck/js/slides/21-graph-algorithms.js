/* 21 · Graph algorithms — one network on the left, the four families selectable
   ...
   The engines that run any of this are slide 22. */
DECK.registerViz('21-graph-algorithms', (slide) => {
