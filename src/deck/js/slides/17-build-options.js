/* 17 · graph construction options — the sibling of slide 18. A vertical rail on
   ...
   inline SVG in the deck's own idiom (slides 04, 15, 20): deterministic
   ...
   Paradigm two runs on the same four documents as slides 14 and 15, and the
   graph beat draws exactly the rows of the table beside it — no more, no fewer.
   The superseded record is drawn the way slide 15 draws it, dimmed and struck
...
DECK.registerViz('17-build-options', (slide) => {
  ...
  const VIZ = {
    ...
    /* Doc A, C and D are three of the four documents on slide 14, and the three
...
FROM docs.corpus`)),
  ...
  /* ── paradigm two · the triples table, drawn ───────────────────────────────
     ...
     row no single document produces; it is drawn the way slide 15 draws the same
