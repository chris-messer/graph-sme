/* 20 · Graph algorithms — one network on the left, the four families selectable
   ...
   The engines that run any of this are slide 21. */
DECK.registerViz('20-graph-algorithms', (slide) => {
