/* 17 · GraphRAG serving options — a vertical option rail drives one stage that
...
DECK.registerViz('17-hop-options', (slide) => {
...
RETURN s, v`)),
  ...
  function render() {
    ...
    panel.innerHTML =
      ...
      '</div>' +
      (o.back ? `<div class="opt-back"><b>Seen already · Taxonomy, slides 06–09</b><span>${o.back}</span></div>` : '') +
